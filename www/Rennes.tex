...
%			\end{itemize}
\textsc{CorReg} retrouve ($p_2=82$) en plus des corrélations ci-dessus des modèles de régulation du process et certains modèles physiques naturels.
\\
...
\begin{figure}[h!]
   ...
   \end{minipage}
  \caption{Histogrammes des corrélations et des $R^2_{adj}$ des régressions obtenues par \textsc{CorReg} }
\end{figure}   
...
\noindent [8] Gilks, W. R., Richardson, S., \& Spiegelhalter, D. J. (Eds.). (1996). Markov chain Monte Carlo in practice (Vol. 2). CRC press.
%
