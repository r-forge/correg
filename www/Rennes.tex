...
%	\subsection{Parcours Markovien de saut}
	...
	A chaque étape, pour $S \in \mathcal{S}$ (ensemble des structures réalisables) on définit un voisinage $\mathcal{V}_{S,j}$ avec $j \sim \mathcal{U}(\{1,\dots,p\}) $ :% de la manière suivante  :	
	\begin{eqnarray}
