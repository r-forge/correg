...
\maketitle
\newpage
\itshape To my sons, to my great friend Quentin Grimonprez, contributor of CorReg. I do not thank Vincent Kubicki, he does not play kazoo with me and says that my latex installation was rotten. \upshape
\tableofcontents
\chapter{Abstracts}
...
\chapter{Missing values}
	...
	\section{How to manage missing values in the MCMC ?}
		Real datasets often have missing values. Here we suppose they are Missing Completely At Random (MCAR). Many methods does exist to manage such problems \cite{little1992regression}. 	
