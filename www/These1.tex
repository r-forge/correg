...
\paragraph{Abstract:} Rapide aperçu de ce qui existe pour tenter de répondre à notre problématique.
...
\chapter{CorReg: the concept}	
	...
	The objective of CorReg is to bring recent statistical tools to engineers. Thus it will be made  available in Microsoft Excel for the end of the year 2014 (probably using BERT). It also provides some small scripts in functions to obtain graphical representations and basic statistics with legends for non-statistician with only one command line (or macro button in Excel). It will be
